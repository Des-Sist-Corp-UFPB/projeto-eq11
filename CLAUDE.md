# Memória do Projeto — StudyAI DSC/UFPB

## Identidade do Projeto
- **Nome**: Sistema StudyAI — Projeto Base DSC
...
docker run --rm aquasec/trivy image studyai:latest
```
...
| Trivy (image) | Vulnerabilidades na imagem Docker | `trivy image studyai:latest` |

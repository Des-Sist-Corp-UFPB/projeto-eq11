...
| **Integrantes** | Clodomir Alves De Oliveira Junior (@clodomiralves) |
...
|---------|---------|-----------|-------------------|----------------------|----------------|
| Clodomir Alves De Oliveira Junior (@clodomiralves) | 1 | 100% | 5.412 | 3.561 | 100% |

### Contribuição por Camada

| Camada | Total linhas | Clodomir Alves De Oliveira Junior (@clodomiralves) |
|--------|-------------|---------|
| Controller | 1.137 | 100% |
| Frontend | 1.336 | 100% |
| Repository | 40 | 100% |
| Service | 456 | 100% |
...
| Arquivo | Total linhas | Clodomir Alves De Oliveira Junior (@clodomiralves) |
|---------|-------------|---------|
| `studyai.css` | 215 | 100% |
| `FlashcardService.java` | 187 | 100% |
| `IAServiceImpl.java` | 154 | 100% |
| `FlashcardController.java` | 122 | 100% |
| `flashcards.html` | 120 | 100% |
| `login.html` | 98 | 100% |
| `home.html` | 93 | 100% |
| `layout.html` | 90 | 100% |
| `studyai.js` | 82 | 100% |
| `flashcard-result.html` | 70 | 100% |
| `AuthController.java` | 48 | 100% |
| `PingController.java` | 47 | 100% |
| `HomeController.java` | 47 | 100% |
| `StudyAiApplication.java` | 44 | 100% |
| `StudyAiApplicationTests.java` | 43 | 100% |
| `PingControllerTest.java` | 37 | 100% |
| `V2__deck_flashcard.sql` | 33 | 100% |
| `IAService.java` | 28 | 100% |
| `V1__criar_tabela_produto.sql` | 25 | 100% |
| `V3__drop_produto.sql` | 10 | 100% |
